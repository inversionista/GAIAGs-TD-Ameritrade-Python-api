...
setup(
    ...
    name='GAIAGs-td-ameritrade-python-api',

    # Want to make sure people know who made it.
    author='Edwin Londoño',

    # also an email they can use to reach out.
    author_email='edwinlondono@GAIAGsGroup.com',
    ...
    description='From GAIAGsGroup A python client lirbary for the TD Ameritrade API.',
    ...
    url='https://github.com/inversionista/GAIAGs-TD-Ameritrade-Python-api',
    ...
    keywords='GAIAGs, GAIAGsGroup, finance, td ameritrade, api',
